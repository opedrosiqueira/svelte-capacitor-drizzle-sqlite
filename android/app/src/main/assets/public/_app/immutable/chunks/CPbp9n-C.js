...
const Xe = { name: 'applyStyles', enabled: !0, phase: 'write', fn: li, effect: ui, requires: ['computeStyles'] };
function Y(n) {
  return n.split('-')[0];
}
var ft = Math.max,
...
function vi(n) {
  var t = n.state,
    ...
    a = e.roundOffsets,
    l = a === void 0 ? !0 : a,
    h = { placement: Y(t.placement), variation: St(t.placement), popper: t.elements.popper, popperRect: t.rects.popper, gpuAcceleration: i, isFixed: t.options.strategy === 'fixed' };
...
const Je = { name: 'computeStyles', enabled: !0, phase: 'beforeWrite', fn: vi, data: {} };
var Jt = { passive: !0 };
function bi(n) {
  var t = n.state,
    e = n.instance,
...
const tn = { name: 'eventListeners', enabled: !0, phase: 'write', fn: function () {}, effect: bi, data: {} };
...
function Dt(n, t) {
  ...
  var e = t,
    ...
    y = Ts({ reference: b, element: O, placement: i }),
  ...
  if (_ === At && D) {
    ...
    Object.keys(C).forEach(function ($) {
      var ot = [R, x].indexOf($) >= 0 ? 1 : -1,
        at = [L, x].indexOf($) >= 0 ? 'y' : 'x';
      C[$] += j[at] * ot;
    });
  }
  return C;
  ...
  if (!t.modifiersData[s]._skip) {
    for (
      ...
      var D = g[C],
        ...
        ot = [L, x].indexOf(j) >= 0,
        at = ot ? 'width' : 'height',
        M = Dt(t, { placement: D, boundary: u, rootBoundary: p, altBoundary: _, padding: h }),
        F = ot ? ($ ? R : I) : $ ? x : L;
      v[at] > b[at] && (F = oe(F));
      var Gt = oe(F),
        ct = [];
...
const rn = { name: 'popperOffsets', enabled: !0, phase: 'read', fn: Mi, data: {} };
function xi(n) {
  return n === 'x' ? 'y' : 'x';
}
function Ri(n) {
  var t = n.state,
    ...
    A = e.tetherOffset,
    m = A === void 0 ? 0 : A,
    E = Dt(t, { boundary: l, rootBoundary: h, padding: p, altBoundary: u }),
    T = Y(t.placement),
    w = St(t.placement),
    O = !w,
    g = Ze(T),
  ...
  if (b) {
    if (r) {
      var $,
        ...
        si = O ? -y[M] / 2 + qt + lt + Qt + C.mainAxis : Rt + lt + Qt + C.mainAxis,
...
const Cs = { name: 'preventOverflow', enabled: !0, phase: 'main', fn: Ri, requiresIfExists: ['offset'] };
function ki(n) {
...
function Wi(n, t, e) {
  ...
  var s = V(t),
    ...
    l = { x: 0, y: 0 };
  return (
    (s || (!s && !e)) && ((z(t) !== 'body' || sn(r)) && (a = Vi(t)), V(t) ? ((l = Nt(t, !0)), (l.x += t.clientLeft), (l.y += t.clientTop)) : r && (l.x = nn(r))),
        ...
        forceUpdate: function () {
          if (!_) {
            var T = u.elements,
              ...
              O = T.popper;
            if (Sn(w, O)) {
              (u.rects = { reference: Wi(w, Ft(O), u.options.strategy === 'fixed'), popper: Qe(O) }),
                (u.reset = !1),
...
class Ut extends K {
  ...
  _addEventListeners() {
    this._config.keyboard && c.on(this._element, Hr, (t) => this._keydown(t)),
      this._config.pause === 'hover' && (c.on(this._element, Wr, () => this.pause()), c.on(this._element, Br, () => this._maybeEnableCycle())),
...
c.on(document, ho, Ye, function (n) {
  ...
  for (const t of d.getMultipleElementsFromSelector(this)) jt.getOrCreateInstance(t, { toggle: !1 }).toggle();
});
B(jt);
const Pn = 'dropdown',
  Ao = 'bs.dropdown',
...
class $t extends K {
  ...
  show(t) {
    this._isShown ||
      ...
      ((this._isShown = !0), (this._isTransitioning = !0), this._scrollBar.hide(), document.body.classList.add(jn), this._adjustDialog(), this._backdrop.show(() => this._showElement(t)));
  }
  hide() {
    !this._isShown ||
      this._isTransitioning ||
...
class xt extends K {
  ...
  _configAfterMerge(t) {
    return (
      (t.container = t.container === !1 ? document.body : tt(t.container)),
...
const pc = 'popover',
  _c = '.popover-header',
  mc = '.popover-body',
  gc = { ...xt.Default, content: '', offset: [0, 8], placement: 'right', template: '<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>', trigger: 'click' },
  Ec = { ...xt.DefaultType, content: '(null|string|element|function)' };
class un extends xt {
  static get Default() {
    return gc;
  }
...
class Lt extends K {
  ...
  show() {
    ...
    const e = this._getActiveElem(),
      s = e ? c.trigger(e, Rc, { relatedTarget: t }) : null;
